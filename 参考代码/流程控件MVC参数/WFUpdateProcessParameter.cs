...
namespace CIIC.HSR.TSP.WF.UI.Control.Interfaces
{
    ...
    public class WFUpdateProcessParameter : WFParameterWithResponseBase
    {
        ...
        {
            if (this.IsUpdateProcessParameter == true)//更新参数才需要检查
            {
        ...
        /// 是否更新流程上下文参数
        /// </summary>
        public bool IsUpdateProcessParameter
        {
            set;
            get;
        }
        ...
        protected override void InternalExecute(ResponseData response)
        {
            ...
            if (this.IsUpdateProcessParameter)
            {
            ...
            {
                response.ProcessInfo = WfClientProcessRuntimeServiceProxy.Instance.GetProcessInfoByID(this.ProcessId,this.RuntimeContext.Operator);
            }
