...
{
    public class SearchFiles : ObjectDataSourceQueryAdapterBase<AppCommonInfo, AppCommonInfoCollection>
    {
	...
	public class SearchFullData
	{
		public static readonly SearchFullData Instance = new SearchFullData();

		private SearchFullData()
		{
		}
