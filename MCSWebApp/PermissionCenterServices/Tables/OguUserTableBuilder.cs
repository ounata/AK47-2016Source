...
namespace PermissionCenter.Tables
{
    ...
    {
        protected override IList<string> GetReservedProperies()
        {
            IList<string> reservered = base.GetReservedProperies();

            AddNotExistedProperty(reservered, "FirstName");
            AddNotExistedProperty(reservered, "LastName");
            AddNotExistedProperty(reservered, "AccountDisabled");
            AddNotExistedProperty(reservered, "PasswordNotRequired");
            AddNotExistedProperty(reservered, "DontExpirePassword");

            AddNotExistedProperty(reservered, "AccountInspires");
            AddNotExistedProperty(reservered, "AccountExpires");

            AddNotExistedProperty(reservered, "Address");
            AddNotExistedProperty(reservered, "MP");
            AddNotExistedProperty(reservered, "WP");
            AddNotExistedProperty(reservered, "Sip");

            AddNotExistedProperty(reservered, "OtherMP");
            AddNotExistedProperty(reservered, "CompanyName");
            AddNotExistedProperty(reservered, "DepartmentName");

            return reservered;
        }

        protected override IList<string> GetIgnoredProperies()
        {
            IList < string > ignored=base.GetIgnoredProperies();

            AddNotExistedProperty(ignored, "PhotoKey");
