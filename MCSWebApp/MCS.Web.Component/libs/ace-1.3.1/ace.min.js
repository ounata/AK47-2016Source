"ace" in window || (window.ace = {}), "helper" in window.ace || (window.ace.helper = {}), "options" in window.ace || (window.ace.options = {}), "vars" in window.ace || (window.ace.vars = {
        icon: " ace-icon ",
        ".icon": ".ace-icon"
    }), ace.vars.touch = "ontouchstart" in document.documentElement, ace.general_vars = function(e) {
        var a = "menu-min",
            t = "responsive-min",
            i = "h-sidebar",
            s = e("#sidebar").eq(0);
        ...
        //add by liucy
        window.sidebar_handle_complete = true;
        ...
        if ("querySelector" in document && "removeProperty" in document.documentElement.style) {
            ...
            var s = "getComputedStyle" in window ? function(e, a) {
                ...
                //     return 0;
                // }
                return e ? e.offsetHeight : 0, e ? window.getComputedStyle(e).position == a : false;
            } : function(a, t) {
                return a ? a.offsetHeight : 0, e ? e(a).css("position") == t : false;
            };
        ...
        e("#skin-colorpicker").on("change", function() {
            ...
            if ("no-skin" == a) {
                ...
                var s = 0;
                e(".sidebar-shortcuts .btn").each(function() {
                    e(this).attr("class", "btn btn-primary btn-white"), e(this).find(ace.vars[".icon"]).addClass(i[s++])
                })
            }
            "sidebar_scroll" in ace.helper && ace.helper.sidebar_scroll.reset()
        })
