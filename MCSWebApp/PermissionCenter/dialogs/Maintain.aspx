...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div class="pc-tabs-content3">
        <div class="pc-tabs-content pc-active" style="clear: none">
            <fieldset>
                ...
                <button type="button" class="pc-button" id="btnClearCache" title="手工清除组织、人员和授权的缓存">
                    清除缓存</button>
                <legend>快照数据</legend>
                <div>
                    <div style="display: none">
    ...
    <script type="text/javascript">
        ...
        $pc.bindEvent("btnClearCache", "click", function () {
            if (confirm("确定要清除缓存吗？")) {
                document.getElementById('<%=btnClearServerCache.ClientID %>').click();
            }
        });
