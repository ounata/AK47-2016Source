...
{
    [TestClass]
    public class UpdateCustomerSearchByCustomerTaskTest
    {
        [TestMethod]
        public void InitCustomerSearchByTaskTest()
        {
            ...
            UpdateCustomerSearchByCustomerTask.Instance.InitCustomerSearchByTask(customerIDList);
