...
{
    /// <summary>
    /// This object represents the properties and methods of a AccountReturnApply.
    /// 服务费返还申请表
    /// </summary>
    [Serializable]
    [ORTableMapping("AccountReturnApplies")]
    [DataContract]
    ...
    [Serializable]
    [DataContract]
    public class AccountReturnApplyCollection : EditableDataObjectCollectionBase<AccountReturnApply>
    {
    }
}