...
{
    public class AccountDebookExecutor : PPTSCustomerExecutorBase
    {
        public AccountDebookExecutor(string opType) : base(opType)
        {
        ...
        protected override object DoOperation(DataExecutionContext<UserOperationLogCollection> context)
        {
            ...
            else if (OperationType == "RollbackDebook")
            {
                AccountAdapter.Instance.UpdateInContext(Account);
