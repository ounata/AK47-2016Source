...
namespace PPTS.Data.Common.Executors
{
    ...
    public abstract class PPTSEditAccountExecutorBase<TModel> : PPTSEditEntityExecutorBase<TModel>
    {
        /// <summary>
        /// /
        /// </summary>
        ...
        public PPTSEditAccountExecutorBase(TModel model, Action<TModel> dataAction) :
        ...
        public PPTSEditAccountExecutorBase(TModel model, Action<TModel> dataAction, string opType) :
