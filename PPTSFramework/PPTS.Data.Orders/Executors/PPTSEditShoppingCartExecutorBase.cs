...
{
    public abstract class PPTSEditShoppingCartExecutorBase<TModel> : PPTSEditEntityExecutorBase<TModel>
    {
        /// <summary>
        /// /
        /// </summary>
        ...
        public PPTSEditShoppingCartExecutorBase(TModel model, Action<TModel> dataAction) :
        ...
        public PPTSEditShoppingCartExecutorBase(TModel model, Action<TModel> dataAction, string opType) :
