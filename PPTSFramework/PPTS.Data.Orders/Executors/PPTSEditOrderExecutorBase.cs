...
{
    public abstract class PPTSEditOrderExecutorBase<TModel> : PPTSEditEntityExecutorBase<TModel>
    {
        /// <summary>
        /// /
        /// </summary>
        ...
        public PPTSEditOrderExecutorBase(TModel model, Action<TModel> dataAction) :
        ...
        public PPTSEditOrderExecutorBase(TModel model, Action<TModel> dataAction, string opType) :
