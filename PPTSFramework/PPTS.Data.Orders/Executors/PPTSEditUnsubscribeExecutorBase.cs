...
{
    public abstract class PPTSEditUnsubscribeExecutorBase<TModel> : PPTSEditEntityExecutorBase<TModel>
    {
        /// <summary>
        /// /
        /// </summary>
        ...
        public PPTSEditUnsubscribeExecutorBase(TModel model, Action<TModel> dataAction) :
        ...
        public PPTSEditUnsubscribeExecutorBase(TModel model, Action<TModel> dataAction, string opType) :
