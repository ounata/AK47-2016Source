CREATE TABLE [SM].[ConsultCampusPerfDaySum]
(
    ...
    CONSTRAINT [PK_ConsultCampusPerfDaySum] PRIMARY KEY NONCLUSTERED ([CampusID], [Year], [Month], [Day]) 
)
...
EXEC sp_addextendedproperty @name = N'MS_Description',
    ...
    @level0name = N'SM',
    @level1type = N'TABLE',
    @level1name = N'ConsultCampusPerfDaySum',
    @level2type = N'COLUMN',
