CREATE TABLE [SM].[ConsultCampusCrmDaySum]
(
    ...
    CONSTRAINT [PK_ConsultCampusCrmDaySum] PRIMARY KEY NONCLUSTERED ([CampusID], [Year], [Month], [Day]) 
)
...
EXEC sp_addextendedproperty @name = N'MS_Description',
    ...
    @level0name = N'SM',
    @level1type = N'TABLE',
    @level1name = N'ConsultCampusCrmDaySum',
    @level2type = N'COLUMN',
