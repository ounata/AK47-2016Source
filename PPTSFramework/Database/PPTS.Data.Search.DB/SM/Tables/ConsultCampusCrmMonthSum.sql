CREATE TABLE [SM].[ConsultCampusCrmMonthSum]
(
    ...
    CONSTRAINT [PK_ConsultCampusCrmMonthSum] PRIMARY KEY NONCLUSTERED ([CampusID], [Year], [Month]) 
)
...
EXEC sp_addextendedproperty @name = N'MS_Description',
    ...
    @level0name = N'SM',
    @level1type = N'TABLE',
    @level1name = N'ConsultCampusCrmMonthSum',
    @level2type = N'COLUMN',
