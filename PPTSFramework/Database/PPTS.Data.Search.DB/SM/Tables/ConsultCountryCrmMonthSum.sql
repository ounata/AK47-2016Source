CREATE TABLE [SM].[ConsultCountryCrmMonthSum]
(
    [Year] INT NOT NULL, 
    [Month] INT NOT NULL, 
    ...
    CONSTRAINT [PK_ConsultCountryCrmMonthSum] PRIMARY KEY NONCLUSTERED ([Year], [Month]) 
)
...
EXEC sp_addextendedproperty @name = N'MS_Description',
    ...
    @level0name = N'SM',
    @level1type = N'TABLE',
    @level1name = N'ConsultCountryCrmMonthSum',
    @level2type = N'COLUMN',
    @level2name = N'Year'
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
