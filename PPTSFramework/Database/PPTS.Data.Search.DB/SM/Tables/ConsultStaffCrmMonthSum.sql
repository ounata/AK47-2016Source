CREATE TABLE [SM].[ConsultStaffCrmMonthSum]
(
    ...
    CONSTRAINT [PK_ConsultStaffCrmMonthSum] PRIMARY KEY NONCLUSTERED ([StaffJobID], [Year], [Month]) 
)
...
EXEC sp_addextendedproperty @name = N'MS_Description',
    ...
    @level0name = N'SM',
    @level1type = N'TABLE',
    @level1name = N'ConsultStaffCrmMonthSum',
    @level2type = N'COLUMN',
