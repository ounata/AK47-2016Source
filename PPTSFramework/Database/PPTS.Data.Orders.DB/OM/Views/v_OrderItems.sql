...
SELECT  OM.Orders.CampusID, OM.Orders.CampusName, OM.Orders.ParentID, OM.Orders.ParentName, OM.Orders.CustomerID, 
                   ...
                   OM.OrderItems.CatalogName, OM.OrderItems.CategoryType, OM.OrderItems.CategoryTypeName, 
                   OM.OrderItems.CourseLevel, OM.OrderItems.CourseLevelName, OM.OrderItems.LessonDuration, 
                   OM.OrderItems.LessonDurationValue, OM.OrderItems.ProductCampusID, OM.OrderItems.ProductCampusName, 
                   OM.OrderItems.OrderPrice, OM.OrderItems.OrderAmount, OM.OrderItems.PresentID, OM.OrderItems.PresentQuato, 
                   OM.OrderItems.PresentAmount, OM.OrderItems.TunlandRate, OM.OrderItems.SpecialRate, OM.OrderItems.DiscountType, 
                   OM.OrderItems.DiscountRate, OM.OrderItems.RealPrice, OM.OrderItems.RealAmount, OM.OrderItems.PromotionQuota, 
                   OM.OrderItems.ExpirationDate, OM.OrderItems.JoinedClassID, OM.OrderItems.RelatedAssetID, 
                   OM.OrderItems.RelatedAssetCode, OM.Assets_Current.AssetID, OM.Assets_Current.AssetCode, 
                   OM.Assets_Current.AssignedAmount, OM.Assets_Current.ConfirmedAmount, OM.Assets_Current.ExchangedAmount, 
                   OM.Assets_Current.DebookedAmount, OM.Assets_Current.ConfirmedMoney, OM.Assets_Current.ReturnedMoney, 
                   OM.Assets_Current.Amount, OM.Assets_Current.Price
