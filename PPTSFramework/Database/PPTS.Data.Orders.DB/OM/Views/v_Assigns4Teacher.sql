...
SELECT  AssignID, AssignTime, AssignStatus, CampusID, CampusName, AssignPrice, AssignSource, AssignMemo, CopyAllowed, 
                   ...
                   CustomerName, ProductID, ProductCode, ProductName,CategoryType, CategoryTypeName, RoomID, RoomCode, RoomName, TeacherID, TeacherName, 
...
SELECT  [AssignID], [AssignTime], [AssignStatus], [CampusID], 
                   [CampusName], NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
