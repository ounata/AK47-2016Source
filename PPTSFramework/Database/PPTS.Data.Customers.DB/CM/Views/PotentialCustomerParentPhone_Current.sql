CREATE VIEW [CM].[PotentialCustomerParentPhone_Current]
AS
...
FROM CM.PotentialCustomers_Current CM LEFT JOIN CM.CustomerParentRelations_Current R ON CM.CustomerID = R.CustomerID AND R.IsPrimary = 1
