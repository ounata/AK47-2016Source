...
(
    ...
    CONSTRAINT [PK_CustomerRelationAuthorizations] PRIMARY KEY ([ObjectID], [ObjectType], [OwnerID], [OwnerType]) 
)
...
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'授权对象类别:“咨询关系”、“学管关系”、“教学关系”、“市场关系”、“电销关系”、“建档关系”(10)',
    @level0type = N'SCHEMA',
    @level0name = N'MT',
    @level1type = N'TABLE',
    @level1name = N'CustomerRelationAuthorizations',
...
CREATE INDEX [IX_CustomerRelationAuthorizations_01] ON [MT].[CustomerRelationAuthorizations] ([OrgType], [OwnerID], [OwnerType])
