        ...
        public static int Main(string[] args)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    catch (System.Runtime.Remoting.RemotingException ex)
                    {
                        if (ServiceArguments.Current.EntryType == ServiceEntryType.Application)
                            MCSServiceMain.Instance.ServiceContainer.Log.Write(ex.Message, LogPriority.Normal, ServiceLogEventID.SERVICEMAIN_MAIN, TraceEventType.Warning, "RemotingConfiguration.Configure异常");
                        else
                            throw;
                    }
                ...
                catch (Exception ex)
                {
                    try
                    {
                        MCSServiceMain.Instance.ServiceContainer.Log.Write(ex, ServiceLogEventID.SERVICEMAIN_MAIN);
                    }
                    catch
                    {
