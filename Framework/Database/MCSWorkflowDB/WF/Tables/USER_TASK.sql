CREATE TABLE [WF].[USER_TASK] (
    ...
    [STATUS]                NCHAR (1)       NULL,
    [TASK_START_TIME]       DATETIME        CONSTRAINT [DF_USER_TASK_TASK_START_TIME] DEFAULT (GETUTCDATE()) NULL,
    ...
    [DELIVER_TIME]          DATETIME        CONSTRAINT [DF_USER_TASK_DELIVER_TIME] DEFAULT (GETUTCDATE()) NULL,
