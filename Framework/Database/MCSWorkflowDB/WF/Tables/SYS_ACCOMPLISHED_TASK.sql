CREATE TABLE [WF].[SYS_ACCOMPLISHED_TASK]
(
	...
	CONSTRAINT [PK_SysAccomplishedTask] PRIMARY KEY NONCLUSTERED ([TASK_GUID] ASC)
)

GO

CREATE INDEX [IX_SYS_ACCOMPLISHED_TASK_TENANT_CODE] ON [WF].[SYS_ACCOMPLISHED_TASK] ([TENANT_CODE])
...
EXEC sp_addextendedproperty @name = N'MS_Description',
    ...
    @level0name = N'WF',
    @level1type = N'TABLE',
    @level1name = N'SYS_ACCOMPLISHED_TASK',
    @level2type = N'COLUMN',
...
CREATE CLUSTERED INDEX [IX_SYS_TASK_SortID] ON [WF].[SYS_ACCOMPLISHED_TASK] ([SORT_ID])

GO

CREATE INDEX [IX_SYS_TASK_ResourceID] ON [WF].[SYS_ACCOMPLISHED_TASK] ([RESOURCE_ID])

GO

CREATE INDEX [IX_SYS_TASK_SourceID] ON [WF].[SYS_ACCOMPLISHED_TASK] ([SOURCE_ID])

GO


CREATE FULLTEXT INDEX ON [WF].[SYS_ACCOMPLISHED_TASK] ([TASK_TITLE] LANGUAGE 2052)
KEY INDEX [PK_SysAccomplishedTask] ON [MCS_WORKFLOW] WITH CHANGE_TRACKING AUTO
