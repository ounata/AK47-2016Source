CREATE TABLE [WF].[MATERIAL_CONTENT] (
    ...
    [CREATE_TIME]  DATETIME        CONSTRAINT [DF_MATERIAL_CONTENT_CREATE_TIME] DEFAULT (GETUTCDATE()) NULL,
    [UPDATE_TIME]  DATETIME        CONSTRAINT [DF_MATERIAL_CONTENT_UPDATE_TIME] DEFAULT (GETUTCDATE()) NULL,
