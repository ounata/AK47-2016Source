CREATE TABLE [WF].[ACTIVITY_TEMPLATE] (
    ...
    [CREATE_TIME]  DATETIME       CONSTRAINT [DF_ACTIVITY_TEMPLATE_CREATE_TIME] DEFAULT (GETUTCDATE()) NULL,
...
CREATE INDEX [IX_ACTIVITY_TEMPLATE_TENANT_CODE] ON [WF].[ACTIVITY_TEMPLATE] ([TENANT_CODE])
