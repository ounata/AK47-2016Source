CREATE TABLE [WF].[PENDING_ACTIVITIES] (
    ...
    [CREATE_TIME]      DATETIME      CONSTRAINT [DF_PENDING_ACTIVITIES_CREATE_TIME] DEFAULT (GETUTCDATE()) NULL,
...
CREATE INDEX [IX_PENDING_ACTIVITIES_TENANT_CODE] ON [WF].[PENDING_ACTIVITIES] ([TENANT_CODE])
