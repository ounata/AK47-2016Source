CREATE TABLE [WF].[IMAGE] (
    ...
    [CREATE_TIME]   DATETIME       CONSTRAINT [DF_IMAGE_CREATE_TIME] DEFAULT (GETUTCDATE()) NULL,
    [UPDATE_TIME]   DATETIME       CONSTRAINT [DF_IMAGE_UPDATE_TIME] DEFAULT (GETUTCDATE()) NULL,
