CREATE TABLE [WF].[GENERIC_FORM_DATA] (
    ...
    [CREATE_TIME]    DATETIME       CONSTRAINT [DF_FORM_DATA_CREATE_TIME] DEFAULT (GETUTCDATE()) NOT NULL,
...
CREATE INDEX [IX_GENERIC_FORM_DATA_TENANT_CODE] ON [WF].[GENERIC_FORM_DATA] ([TENANT_CODE])
