CREATE TABLE [WF].[APPLICATIONS_COMMON_INFO] (
    ...
    [CREATE_TIME]           DATETIME       CONSTRAINT [DF_APPLICATIONS_COMMON_INFO_CREATE_TIME] DEFAULT (GETUTCDATE()) NULL,
...
CREATE INDEX [IX_APPLICATIONS_COMMON_INFO_TENANT_CODE] ON [WF].[APPLICATIONS_COMMON_INFO] ([TENANT_CODE])
