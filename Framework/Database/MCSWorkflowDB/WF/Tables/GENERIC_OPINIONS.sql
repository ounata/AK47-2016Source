CREATE TABLE [WF].[GENERIC_OPINIONS] (
    ...
    [ISSUE_DATETIME]     DATETIME       CONSTRAINT [DF_GENERIC_OPINIONS_ISSUE_DATETIME] DEFAULT (GETUTCDATE()) NULL,
    [APPEND_DATETIME]    DATETIME       CONSTRAINT [DF_GENERIC_OPINIONS_APPEND_DATETIME] DEFAULT (GETUTCDATE()) NULL,
...
CREATE INDEX [IX_GENERIC_OPINIONS_TENANT_CODE] ON [WF].[GENERIC_OPINIONS] ([TENANT_CODE])
