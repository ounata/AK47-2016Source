CREATE TABLE [WF].[USER_ACCOMPLISHED_TASK] (
    ...
    [STATUS]                NCHAR (1)       NULL,
    [TASK_START_TIME]       DATETIME        CONSTRAINT [DF_USER_ACCOMPLISHED_TASK_TASK_START_TIME] DEFAULT (GETUTCDATE()) NULL,
    ...
    [COMPLETED_TIME]        DATETIME        CONSTRAINT [DF_USER_ACCOMPLISHED_TASK_COMPLETED_TIME] DEFAULT (GETUTCDATE()) NULL,
    [DRAFT_DEPARTMENT_NAME] NVARCHAR (512)  NULL,
    [DELIVER_TIME]          DATETIME        CONSTRAINT [DF_USER_ACCOMPLISHED_TASK_DELIVER_TIME] DEFAULT (GETUTCDATE()) NULL,
...
CREATE NONCLUSTERED INDEX [IX_USER_ACCOMPLISHED_TASK_RESOURCE_ID]
    ON [WF].[USER_ACCOMPLISHED_TASK]([RESOURCE_ID], [TENANT_CODE]);
