...
namespace MCS.Library.SOA.DataObjects.Security
{
    public static class SchemaExtensions
    {
        ...
        public static void SchemaToSqlClauseBuilder<TBuilder>(this SchemaObjectBase obj, SnapshotModeDefinition constSmd, TBuilder builder) where TBuilder : SqlClauseBuilderIUW<TBuilder>
        {
