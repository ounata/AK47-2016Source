...
(
	SELECT ID, ParentID, Name, DisplayName, SchemaType, CreateDate, CreatorID, CreatorName, VersionStartTime, VersionEndTime, [Status] FROM SC.[SchemaObjectAndParentView] (NOLOCK)
	...
	FROM SC.[SchemaObjectAndParentView] (NOLOCK) O INNER JOIN PARENT_OBJS P ON O.ID = P.ParentID
