...
namespace MCS.Library.SOA.DataObjects
{
    ...
    {
        private static readonly string DELETE_JOB_START_WORKFLOW_SQL_CLAUSE = "DELETE WF.JOB_START_WORKFLOW WHERE ";
        ...
        private const string SingleData_StartWorkflowJob = "SELECT TOP(1) * FROM WF.JOB_START_WORKFLOW WHERE {0}";
