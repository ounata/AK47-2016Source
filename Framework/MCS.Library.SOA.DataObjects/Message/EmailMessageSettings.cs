...
namespace MCS.Library.SOA.DataObjects
{
    ...
    public sealed class EmailMessageSettings : ConfigurationSection
    {
        ...
        /// 是否启用假冒的邮件发送目标
        /// </summary>
        [ConfigurationProperty("enableFakeTarget", DefaultValue = false, IsRequired = false)]
        public bool EnableFakeTarget
        {
            get
            {
                return (bool)this["enableFakeTarget"];
            }
        }
        ...
        /// 假冒的邮件发送目标
        /// </summary>
        [ConfigurationProperty("fakeTarget", DefaultValue = "")]
        public string FakeTarget
        {
            get
            {
                return (string)this["fakeTarget"];
            }
        }
