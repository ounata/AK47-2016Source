...
namespace MCS.Library.SOA.DataObjects
{
    ...
    public class GenericOpinion
    {
        ...
        /// 创建意见的时间
        /// </summary>
        [ORFieldMapping("ISSUE_DATETIME", UtcTimeToLocal = true)]
        ...
        /// 修改意见的时间
        /// </summary>
        [ORFieldMapping("APPEND_DATETIME", UtcTimeToLocal = true)]
        [SqlBehavior(ClauseBindingFlags.All, DefaultExpression = "GETUTCDATE()")]
