...
namespace MCS.Library.SOA.DataObjects.Dynamics.Adapters
{
    ...
    /// 快照基本数据操作的Adapter
    /// </summary>
    public class DESnapshotBasicAdapter : VersionedSchemaObjectSnapshotAdapterBase<DESchemaObjectBase>
    {
        /// <summary>
        /// <see cref="SCSnapshotAdapter"/>的实例，此字段为只读
        /// </summary>
        public static readonly DESnapshotBasicAdapter Instance = new DESnapshotBasicAdapter();

        private DESnapshotBasicAdapter()
        {
        }
        ...
        /// <returns></returns>
        public DESchemaObjectBase LoadByID(string schemaType, DESnapshotQueryIDType idType, string id)
        {
