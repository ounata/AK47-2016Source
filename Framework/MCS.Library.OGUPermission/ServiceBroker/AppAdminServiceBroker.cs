...
namespace MCS.Library.OGUPermission
{
    ...
    public sealed class AppAdminServiceBroker : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        /// <returns>指定部门范围下，指定应用系统中，指定角色下的所有人员</returns>
        [ServiceBrokerExtension]
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/GetRolesUsers2", RequestNamespace = "http://tempuri.org/", ResponseNamespace = "http://tempuri.org/", Use = System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle = System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        ...
        /// <returns>指定部门下，指定应用系统中，指定角色的所有被授权对象</returns>
        [ServiceBrokerExtension]
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/GetChildrenInRoles2", RequestNamespace = "http://tempuri.org/", ResponseNamespace = "http://tempuri.org/", Use = System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle = System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public System.Data.DataSet GetChildrenInRoles2(string orgRoot, string appCodeName, string roleCodeNames, bool doesMixSort, bool doesSortRank, bool includeDelegate, bool includeMatrixUsers)
        {
            object[] results = this.Invoke("GetChildrenInRoles2", new object[] {
                        orgRoot,
                        appCodeName,
                        roleCodeNames,
                        doesMixSort,
        ...
        /// <returns>指定用户，在指定应用系统中所拥有的角色</returns>
        [ServiceBrokerExtension]
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/GetUserRoles2", RequestNamespace = "http://tempuri.org/", ResponseNamespace = "http://tempuri.org/", Use = System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle = System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public System.Data.DataSet GetUserRoles2(string userValue, string appCodeName, UserValueType userValueType, RightMaskType rightMask, DelegationMaskType delegationMask, bool includeMatrixUsers)
        {
            object[] results = this.Invoke("GetUserRoles2", new object[] {
                        userValue,
                        appCodeName,
                        userValueType,
                        rightMask,
        ...
        /// <returns>指定人员，在指定应用系统具有的权限（功能）</returns>
        [ServiceBrokerExtension]
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/GetUserPermissions2", RequestNamespace = "http://tempuri.org/", ResponseNamespace = "http://tempuri.org/", Use = System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle = System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
