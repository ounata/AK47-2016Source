...
namespace MCS.Library.Office.OpenXml.Excel
{
    ...
    public class CreatingDataCellParameters<T>
    {
        ...
        public TableColumnDescription ColumnDescription { get; internal set; }
        ...
        public CreatingDataCellParameters(T currentObj, object propertyValue, string columnName, int rowIndex, TableColumnDescription columnDescription)
