...
namespace MCS.Web.WebControls
{
    ...
    public class FileDownloadInfo
    {
        ...
        public static FileDownloadInfo CollectInfoFromRequest()
        {
            ...
            info.RequestContext = WebUtility.GetRequestQueryValue("requestContext", string.Empty);

            info.FilePath = WebUtility.GetRequestQueryValue("filePath", string.Empty);
            ExceptionHelper.CheckStringIsNullOrEmpty(info.FilePath, "filePath");

            info.UserID = WebUtility.GetRequestQueryValue("userID", string.Empty);
            ExceptionHelper.CheckStringIsNullOrEmpty(info.UserID, "userID");

            info.PathType = WebUtility.GetRequestQueryValue("pathType", PathType.relative);

            info.FileName = WebUtility.GetRequestQueryValue("fileName", string.Empty);
            ExceptionHelper.CheckStringIsNullOrEmpty(info.FileName, "fileName");

            info.RootPathName = HttpUtility.UrlEncode(WebUtility.GetRequestQueryValue<string>("rootPathName", string.Empty));
            ...
            info.DownloadType = WebUtility.GetRequestQueryValue("opType", DownloadTypeDefine.Document);
    ...
    internal class FileUpload
    {
        ...
        {
            string rootPathName = HttpUtility.UrlEncode(WebUtility.GetRequestQueryValue<string>("rootPathName", string.Empty));
