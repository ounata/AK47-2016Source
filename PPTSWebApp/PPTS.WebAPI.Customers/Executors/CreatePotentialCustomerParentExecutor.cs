...
{
    [DataExecutorDescription("新建潜客家长")]
    public class CreatePotentialCustomerParentExecutor : PPTSEditCustomerExecutorBase<CreatablePotentialCustomerParentModel>
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public CreatePotentialCustomerParentExecutor(CreatablePotentialCustomerParentModel model)
            : base(model, null)
        {
