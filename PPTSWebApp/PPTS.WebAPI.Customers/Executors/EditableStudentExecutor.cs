...
{
    [DataExecutorDescription("编辑学员信息")]
    public class EditableStudentExecutor : PPTSEditCustomerExecutorBase<EditableStudentModel>
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public EditableStudentExecutor(EditableStudentModel model)
            : base(model, null)
        {
