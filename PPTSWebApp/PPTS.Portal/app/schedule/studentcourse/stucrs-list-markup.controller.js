define([ppts.config.modules.schedule,
        ...
        function (schedule) {
            ...
            '$scope', 'studentassignmentDataService', 'studentCourseDataService', '$uibModalInstance', 'mcsDialogService','dataSyncService',
            function ($scope, studentassignmentDataService, studentCourseDataService, $uibModalInstance, mcsDialogService, dataSyncService) {
                var vm = this;
                //存储时间
