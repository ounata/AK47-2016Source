define([ppts.config.modules.schedule,
        ppts.config.dataServiceConfig.teacherAssignmentDataService], function (schedule) {
            schedule.registerController("tchAsgmtCourseListController", [
              "$scope", '$state', 'dataSyncService', 'teacherAssignmentDataService', '$stateParams', 'mcsDialogService',
                function ($scope, $state, dataSyncService, teacherAssignmentDataService, $stateParams, mcsDialogService) {
                    var vm = this;
