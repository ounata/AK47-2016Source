...
function (product) {
    product.registerController('productCopyController', [
        '$scope', '$location', '$state', '$stateParams', 'dataSyncService', 'productDataService',
        
        function ($scope, $location, $state, $stateParams, dataSyncService, productDataService) {
            var vm = this;
            ...
            $scope.tabs = {
                ...
                'wukeshou': {
                    index: 5, title: '代理招生产品', active: false, templateUrl: 'product-add-other.html'
                    , description: ''
                    , example: ''
                },
            };
