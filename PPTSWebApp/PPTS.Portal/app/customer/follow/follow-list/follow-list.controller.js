define([ppts.config.modules.customer,
        ...
        function (customer) {
            customer.registerController('followListController', ['$scope', 'dataSyncService', 'followDataViewService', 'followListDataHeader', 'followAdvanceSearchItems',
                function ($scope, dataSyncService, followDataViewService, followListDataHeader, searchItems) {
                    var vm = this;
