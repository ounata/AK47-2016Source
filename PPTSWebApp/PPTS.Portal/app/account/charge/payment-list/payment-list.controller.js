                ...
                function ($scope, $state, $stateParams, mcsDialogService, accountChargeDataService) {
                    ...
                    vm.showPrint = function () {
                        if (vm.data.rowsSelected.length != 1) {
                            vm.errorMessage = "请选择要打印的记录";
                            return;
                        }
                        var payID = vm.data.rowsSelected[0].payID;
                        mcsDialogService.create('app/account/charge/payment-list/payment-print.html', {
                            ...
                            accountChargeDataService.saveChargePaymentPrint(print, function (result) {
                                if (result) {
